...
A modern, full-stack RSS reader web application inspired by Inoreader. Subscribe to RSS feeds, organize them into folders, and read articles in a clean list view.
